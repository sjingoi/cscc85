...
int drive_until_street(const struct ColourTrainingSet *ts); // Assuming random placement look for a street
int drive_along_street(const struct ColourTrainingSet *ts, int stop_at_red);
